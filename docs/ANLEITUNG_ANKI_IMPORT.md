...
- `Frage`
> **Hinweis:** Du kannst die Vorlagen bei Bedarf erweitern, z. B. um Metadaten (`{{Fragenset_Titel}}`, `{{Thema}}`, `{{Konzept}}`, `{{Kognitive_Stufe}}`).
...
- **Tags:** Alle Metadaten (z. B. Thema, Konzept) findest du im Feld `Tags_Alle` für die Anki-Suche.
