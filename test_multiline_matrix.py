#!/usr/bin/env python3
"""Test mit mehrzeiligen Matrizen"""

from pdf_export import _parse_text_with_formulas
from weasyprint import HTML

# Test mit mehrzeiligen Matrizen (wie vom User beschrieben)
text = '''
<h2>Test: Mehrzeilige Matrizen</h2>

<h3>Inline einzeilig:</h3>
<p>$\\begin{pmatrix} 1 & 2 \\\\ 3 & 4 \\end{pmatrix}$</p>

<h3>Inline mehrzeilig (mit Newlines):</h3>
<p>$\\begin{pmatrix}
a & b & c \\\\
d & e & f \\\\
g & h & i
...
print("=" * 70)
print("Teste mehrzeilige Matrizen...")
print("=" * 70)
...
# Speichere PDF
output_path = '/Users/kqc/streamlit/test_multiline_matrix.pdf'
with open(output_path, 'wb') as f:
    f.write(pdf_bytes)

print(f"\n✓ PDF erfolgreich erstellt: {output_path}")
print(f"  Dateigröße: {len(pdf_bytes):,} bytes")
print("\n  Teste die mehrzeiligen Matrizen!")
print("\n" + "=" * 70)
